...
public class Collections {
     ...
     * @since 1.4
     */
    // 返回source 指定子串最后一次出现的位置，找不到返回-1
    ...
    // 将已有的Set包装为同步Set(线程安全)，指定的同步的lock
     ...
     */
    // 将已有的SortedSet包装为同步SortedSet(线程安全)
    ...
    // 将已有的list修改为同步的list(线程安全),指定的同步的lock
     ...
     */
    // 不可修改的集合
    // 重写所有修改集合的方法，都抛出UnsupportedOperationException的异常
