...
public class ThreadGroup implements Thread.UncaughtExceptionHandler {
    ...
    private void remove(ThreadGroup g) {
        synchronized (this) {
            ...
            // 移除指定线程组后，若当前线程组中线程数为0，线程组为0，则进行销毁
    ...
    void add(Thread t) {
        synchronized (this) {
            ...
            // 存放线程的数组为空，则创建数组，大小为4
            if (threads == null) {
                threads = new Thread[4];
            }
            // 当前线程数等于线程数组的大小，扩容线程数组 ，2倍
